    ...
    <section id="progects">
        ...
        <div id="progectcover">
            ...
            <div class="progectcolom personaluser">
                ...
                <div class="progecthover userhover"><a target="_blank" <?php
                    if($user->prog1status)
                       echo "href=$user->prog1"; 
                   ?> ></a></div>
                <div class="progectpic userpic" style="background:url(
           <?php echo "$prog1image" ?>); background-position:center; background-size:cover;"></div>
                <a target="_blank" <?php
                    if($user->prog1status)
                       echo "href=$user->prog1"; 
                   ?> class="progectname username">
                    <?php echo $user->progectName1; ?>
                </a>
            </div>
            <div class="progectcolom personaluser">
                <?php if($loged){ echo '<div class="changepr"></div><div class="changeprogdesc">Projects manegment</div>'; } ?>
